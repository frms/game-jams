...
function stepGame(dt) {
	var steering = obstacleAvoidance(gameObjects[0]);
	if(gameObjects[1]) {
		if(vec3.len(steering.linear) == 0) {
			steering = arrive(gameObjects[0], gameObjects[1]);
		}
		
		var lookSteering = lookWhereYoureGoing(gameObjects[0]);
